...
struct macdef {
	...
	/* a variable number of null terminated parameters followed by another
	 * null */
	/* a variable number of null ternimated definition lines followed by
	 * another null */
};
...
LX char filename[MAXINCL *
                 50]; /* save file names for when returning from includes */
